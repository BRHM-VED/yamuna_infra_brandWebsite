...
const ProjectPreviewSection: React.FC = () => {
  ...
  const listProjects = [...projects, projects[0]];
  ...
  return (
    ...
    <section className="w-full bg-white pt-0 pb-16">
      ...
      <div className="w-full relative">
        <div className="relative w-full h-[420px] md:h-[800px] overflow-hidden" style={{ backgroundColor: colors.surfaceMuted }}>
          <img src={featuredImg} alt="Featured project" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="hidden md:block absolute inset-x-10 bottom-10">
          <div
            ...
            style={{ backgroundColor: colors.background, borderColor: colors.border.projectSoft }}
          >
            {/* Left title */}
            <div className="flex flex-col items-start">
              <p style={{ fontFamily: fonts.body, color: colors.accent }} className="text-[12px] font-medium leading-[1.6]">
                {strings.projects.project1}
              </p>
              <p style={{ fontFamily: fonts.heading, color: colors.secondary }} className="text-[18px] font-normal leading-[1.3] tracking-[-0.54px]">
            ...
            <div className="flex items-center gap-6">
              <div className="flex flex-col items-start">
                <p style={{ fontFamily: fonts.body, color: colors.realityCheck.emphasisBrown }} className="text-[12px] leading-none opacity-70">
                ...
                <div className="flex items-end gap-4 mt-1">
                  {strings.projects.bhkOptions.slice(0, 3).map((b) => (
                    <div key={b.val} className="flex items-end gap-1">
                      <span style={{ fontFamily: fonts.body, color: colors.secondary }} className="text-[20px] leading-none font-normal">
                        {b.val}
                      </span>
                      <span style={{ fontFamily: fonts.body, color: colors.secondary }} className="text-[10px] leading-none uppercase opacity-70">
                        {b.label}
                      </span>
                    </div>
                  ))}
                  <div className="flex flex-col items-start leading-none opacity-70">
                    <span style={{ fontFamily: fonts.body, color: colors.secondary }} className="text-[10px]">
              ...
              <div className="w-px h-[44px]" style={{ backgroundColor: colors.border.projectSoft }} />
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="flex items-end gap-1 mt-1">
                  <span style={{ fontFamily: fonts.body, color: colors.secondary }} className="text-[20px] leading-none">
          ...
          <div className="px-[19px] pt-[19px] pb-[16px]">
            ...
            <div className="mt-[18px] flex items-center gap-[16px]">
              <div className="flex flex-col items-start gap-[12px] w-[167px]">
                <p style={{ fontFamily: fonts.body, color: colors.destinationTag }} className="text-[13px] font-medium leading-[1.6]">
                  {strings.projects.unitsAvailable}
                </p>
              ...
              <div className="flex flex-col items-start gap-[12px]">
                ...
                <div className="flex items-end gap-[4.62px]" style={{ fontFamily: fonts.body, color: colors.text.tertiary }}>
                  <span className="text-[28px] leading-none font-normal">{strings.projects.priceNum}</span>
                  <span className="text-[12px] leading-none uppercase">{strings.projects.priceText}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-0 pt-10 md:pt-14">
        ...
        <div className="hidden md:flex items-start justify-between gap-30">
          <div className="w-[320px] flex flex-col justify-between min-h-[400px]">
            ...
            <button
              ...
              style={{ backgroundColor: colors.background, fontFamily: fonts.body, color: colors.text.primary }}
            >
              <span className="text-[14px] font-medium">{strings.common.exploreProjects}</span>
              <span className="text-[16px] leading-none">→</span>
            </button>
          </div>
          <div className="flex-1 max-w-[980px] ml-auto">
            <div ref={desktopListRef} className="grid grid-cols-2 gap-4">
              {projects.map((project, idx) => (
                <div key={idx} onClick={() => navigate(`/projects/${project.title.toLowerCase().replace(/\s+/g, '-')}`)} className="cursor-pointer">
                  <div
                    className="h-[240px] overflow-hidden border"
                    style={{ backgroundColor: colors.surfaceMuted, borderColor: colors.border.projectSoft }}
                  >
                  ...
                  >
                    ...
                    <div className="size-[36px] rounded-full flex items-center justify-center" style={{ backgroundColor: colors.accent }}>
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button
                type="button"
                aria-label="Previous"
                className="size-[56px] rounded-full flex items-center justify-center border"
                style={{ backgroundColor: colors.surface, borderColor: colors.border.light }}
                onClick={() => desktopListRef.current?.scrollBy({ left: -520, behavior: 'smooth' })}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d="M15 18L9 12L15 6" stroke={colors.secondary} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              <button
                type="button"
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d="M9 18L15 12L9 6" stroke={colors.secondary} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            </div>
          </div>
        ...
        <div className="md:hidden flex flex-col gap-[24px]">
          <p style={{ fontFamily: fonts.body, color: colors.text.primary }} className="text-[24px] font-normal leading-[1.19]">
            Latest Projects
          </p>
          <div className="flex flex-col gap-[20px]">
            {listProjects.map((project, idx) => (
              ...
              >
                <div className="h-[240px] overflow-hidden border" style={{ backgroundColor: colors.surfaceMuted, borderColor: colors.border.projectSoft }}>
                  <img src={project.img} alt={project.title} className="w-full h-full object-cover" />
                </div>
                <div className="h-[72px] border flex items-center justify-between px-[13px]" style={{ backgroundColor: colors.background, borderColor: colors.border.projectSoft }}>
                  <div className="flex flex-col gap-[6px]">
                    <p style={{ fontFamily: fonts.body, color: colors.accent }} className="text-[12px] font-medium leading-[1.6]">
                      {project.title}
                    </p>
                  ...
                  <span style={{ color: colors.accent }} className="text-[18px] leading-none">›</span>
                </div>
              </div>
            ))}
          </div>
